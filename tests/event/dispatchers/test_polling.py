...
from midil.event.dispatchers.polling import (
...
from midil.event.dispatchers.abstract import (
...
class TestPollingEventDispatcher:
    ...
    def test_on_decorator_registration(self, polling_dispatcher):
        ...
        async def test_handler(event: str, body: Dict[str, Any]):
            pass
    ...
    def test_on_decorator_returns_original_function(self, polling_dispatcher):
        ...
        async def original_handler(event: str, body: Dict[str, Any]):
            return "test_result"
    ...
    async def test_notify_with_no_observers(self, polling_dispatcher):
        ...
        with patch("midil.event.dispatchers.polling.logger") as mock_logger:
    ...
    @patch("midil.event.dispatchers.polling.logger")
    async def test_notify_logging_messages(
        self, mock_logger, polling_dispatcher
    ) -> None:
    ...
    async def test_integration_with_decorator_and_notify(
        self, polling_dispatcher
    ) -> None:
        ...
        @polling_dispatcher.on("integration.test")
        async def handler2(event: str, body: Dict[str, Any]) -> None:
    ...
    async def test_complex_event_types(self, polling_dispatcher) -> None:
    ...
    async def test_observer_exception_handling(self, polling_dispatcher) -> None:
    ...
    def test_inspect_method_detection(self, polling_dispatcher) -> None:
    ...
    async def test_empty_body_handling(self, polling_dispatcher) -> None:
